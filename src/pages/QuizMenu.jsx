...
export default function QuizMenu({ db, onSelect, onBack }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: THEME.white, fontFamily: "'Pretendard', sans-serif", color: THEME.textBlack, WebkitFontSmoothing: "antialiased" }}>
      ...
      <section style={{ background: THEME.bgHeader, padding: "90px 0 70px 0", width: "100%" }}>
            ...
            {onBack && (
              <button
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: "6px",
                  color: THEME.textGrayLight,
                  fontSize: "13px",
                  fontWeight: "600",
                  padding: "4px 0",
                  transition: "color 0.2s",
                }}
                onMouseEnter={e => e.currentTarget.style.color = THEME.textBlack}
                onMouseLeave={e => e.currentTarget.style.color = THEME.textGrayLight}
              >
